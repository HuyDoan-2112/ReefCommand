    ...
    return fuse(
        ...
        [
            CauseEvidence(
                ...
                support=0.8,
                confidence=0.8,
                display_summary="Heat support is high.",
                key_findings=["High heat was observed."],
                rationale="heat",
            ...
            CauseEvidence(
                ...
                support=0.7,
                confidence=0.8,
                display_summary="Disease support is high.",
                key_findings=["A lesion was observed."],
                rationale="lesion",
                computed_at=datetime.now(UTC),
            ),
            CauseEvidence(
            ...
            CauseEvidence(
                ...
                key_findings=["No damage was observed."],
                rationale="no damage",
                computed_at=datetime.now(UTC),
            ),
        ],
